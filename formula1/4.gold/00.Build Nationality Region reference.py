...
# MAGIC 1. Create a dataframe with list of nationality and corresponding geographic regions
# MAGIC 2. Write the dataframe to gold schema
...
# MAGIC %md
# MAGIC ### 2. Write the dataframe to the `gold` `ref_nationality_region` table
...
(
    ref_nationality_region_df
        ...
        .format("delta")
        .mode("overwrite")             
        .saveAsTable("formula1.gold.ref_nationality_region")
)

# COMMAND ----------

display(spark.table("formula1.gold.ref_nationality_region"))